...
namespace Alexandra_s_Trove
{
    public partial class ReviewPage : Form
    {
        ...
        private void pboxArrowU_Click(object sender, EventArgs e)//add stars to the review
        {
        ...
        private void pboxArrowD_Click(object sender, EventArgs e)//decrease no of stars of review
        {
            int stars = Int32.Parse(tboxNumberOfStars.Text);
            if (stars > 1)
            {
        ...
        private void lblAddReview_Click(object sender, EventArgs e)//adds review to database
        {
            //get data
